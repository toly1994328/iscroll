...
class AnimPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    textPainter.text = TextSpan(
        text: 'ClampingScrollSimulation 仿真器散点图', style: TextStyle(fontSize: 14, color: Colors.black,fontWeight: FontWeight.bold));
    ...
    textPainter.text = TextSpan(
        text: '第 60 帧', style: TextStyle(fontSize: 12, color: Colors.green));
    textPainter.layout(); // 进行布局
